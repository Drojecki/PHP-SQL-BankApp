...
ADDUSERFORM;
    ...
    echo '<br><a href="../Scripts/konto_pracownika.php?showAddUserForm=1">Dodaj użytkownika</a><br>';
...
if (isset($_GET["show"])) {
    ...
    echo <<< ADDUSERFORM
      <h4>Edycja Salda</h4>   
        <form action="./siano1.php?userId=userId" method="post">  
...
ADDUSERFORM;
    ...
    echo '<br><a href="./konto_pracownika.php?show=1">Zmien stan konta</a><br>';
}
...
ADDUSERFORM;
    ...
    echo '<br><a href="./konto_pracownika.php?wyszukaj=1">Wyszukaj</a><br>';
}
