...
$licznik = RAND();
$sql = "INSERT INTO users (ID,Name, Surname,Nr_konta,haslo,email, AccountBalance,admin,IsVerified,link_weryfikacyjny) VALUES (NULL,'$_POST[Name]', '$_POST[Surname]', $licznik, '$haslo_hash','$_POST[email]',0,0,0,NULL);";
