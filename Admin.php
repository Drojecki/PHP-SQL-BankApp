...
<body>
<h1>Bank F&J Konto administratora</h1>
<?php
...
if (isset($_GET["showAddUserForm"])) {
    echo <<< ADDUSERFORM
      ...
      <form action="./Scripts/add_user.php" method="post">
        ...
        <input type="text" name="haslo" placeholder="Podaj haslo"><br><br>
        <input type="text" name="Admin" placeholder="Podaj uprawnienia">
...
ADDUSERFORM;
    ...
    echo '<br><a href=./Scripts/wyloguj.php>wyloguj</a><br/>';
}
if (isset($_GET["show"])) {
...
if (isset($_GET["show1"])) {
    ...
    echo <<< ADDUSERFORM
      <h4>Edycja Salda</h4>   
        ...
        <input type="text" name="Name21" placeholder="1-admin 2-pracownik"><br>
        <input type="number" name="ID" placeholder="ID klienta">
...
ADDUSERFORM;
    ...
    echo '<br><a href="./Admin.php?show1=1">zmien uprawnienia</a><br>';
}
...
if (isset($_GET["wyszukaj"])) {
    ...
    echo <<< ADDUSERFORM
      <h4>Edycja Salda</h4>   
        <form action="./Scripts/wyszukiwarka.php?search" method="post">  
